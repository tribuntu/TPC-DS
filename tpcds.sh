...
# run the benchmark
./rollout.sh ${GEN_DATA_SCALE} ${EXPLAIN_ANALYZE} ${RANDOM_DISTRIBUTION} ${MULTI_USER_COUNT} ${RUN_COMPILE_TPCDS} ${RUN_GEN_DATA} ${RUN_INIT} ${RUN_DDL} ${RUN_LOAD} ${RUN_SQL} ${RUN_SINGLE_USER_REPORT} ${RUN_MULTI_USER} ${RUN_MULTI_USER_REPORT} ${RUN_SCORE} ${SINGLE_USER_ITERATIONS} ${BENCH_ROLE}
